...
const DashboardMain = () => {
  return (
    <div className="flex flex-1 h-full overflow-hidden">
      <div className="p-3 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col flex-1 w-full h-full overflow-hidden">
