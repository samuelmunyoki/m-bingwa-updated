...
const StoreMain = ({ userId }: { userId: string }) => {
  return (
    <div className="flex flex-1 h-full overflow-hidden">
      <div className="px-4 md:px-3 py-2 rounded-lg border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 flex flex-col flex-1 w-full gap-2 overflow-hidden">
